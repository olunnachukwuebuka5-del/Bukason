...
// cause (see debug log returned to the client). Google has been iterating
// on this model name — if this one starts failing, check
...
const ALLOWED_ATTACHMENT_MIMES = ['image/png', 'image/jpeg', 'image/webp', 'image/gif', 'image/heic', 'image/heif', 'application/pdf'];
